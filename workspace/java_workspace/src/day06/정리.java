...
public class 정리 {
	...
	public static void main(String[] args) {
		 ...
		 *  - 참조형 : 객체의 주소를 저장하는 변수(객체명) : new 키워드를 통해 객체 생성
		 *  - 자료형 변환 : 변수, 상수, 리터럴 값들을 일시적으로 다른 자료현으로 변환
		 ...
		 *  - 비교연산자 ( >=(크거나같다) , <=(작거나같다) , >(크다) , <(작다), ==, !=)
		 *    > 항상 결과가 true / false로 표현
		 *  - 논리연산자( &&, ||, ! )
		 *    > && : and 여러개의 조건이 모두 맞아야 true / ~이고,
		 *    > || : or 여거래의 조건 중 하나만 맞아도 true / ~이거나, ~또는
		 *    > ! : not 현재 조건의 반대
		 *  - 증감연산자( ++ , -- )
		 ...
		 *   > switch : 값이 나오는 식, 변수
		 *    			반드시 하나의 case가 끝나면 break문을 달아줘야함.
