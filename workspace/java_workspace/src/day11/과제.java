...
public class 과제 {
	...
	public static void main(String[] args) {
		 ...
		 * (스트링배열 5개 만들고 파일명.확장자 5개 받을거임)
		 * 
		 * 입력받은 파일 중 이미지 파일을 검색하여 출력하는 코드 작성
		 * 이미지파일 형식은 (jpg, png, gif, jpeg)
		 * String[] fileName = {"java.txt", "String.jpg", 
		 *						"metod.png" , "String.pdf", "Java.pdf"}
		 *
		 * -- 이미지 파일--
		 * String.jpg
		 * metod.png
		...
		//String[] fileName = {"java.txt", "String.jpg", "metod.png" , "String.pdf", "Java.pdf"};
